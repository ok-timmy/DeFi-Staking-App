...
describe("Mock Tether Deployment", async () => {
  ...
  it("Has Transferred all Tokens to the Decentral Bank", async () => {
      ...
      // console.log(signer);
      await tether.connect(tether.signer.signTransaction(tether.approve())).approve(decentralBank.address, "10000000000000000000");
      await decentralBank.connect(spender.address).depositTokens("10000000000000000000", {from: spender.address});
